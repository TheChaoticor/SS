...
export default function SignupPage() {
  ...
  return (
    <SiteLayout>
      <div className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-12">
        ...
        <motion.div
          ...
          className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-white/10 bg-[#071224]/80 shadow-2xl backdrop-blur-xl"
        >
          {/* Header */}
