...
export default function LoginPage() {
  ...
  return (
    <SiteLayout>
      <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-12">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md overflow-hidden rounded-3xl border border-white/10 bg-[#071224]/80 p-8 shadow-2xl backdrop-blur-xl"
        >
          {/* Header */}
